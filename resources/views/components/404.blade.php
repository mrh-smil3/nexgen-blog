...
<body>
    <div class="bg-gradient-to-r from-pink-300 to-red-200">
        <div class="w-9/12 m-auto py-16 min-h-screen flex items-center justify-center">
            <div class="bg-white shadow overflow-hidden sm:rounded-lg pb-8">
                <div class="border-t border-gray-200 text-center pt-8">
                    ...
                    <button id="home"
                        class="bg-gradient-to-r from-pink-400 to-red-500 hover:from-pink-500 hover:to-orange-500 text-white font-semibold px-6 py-3 rounded-md mr-6">
                        HOME
                    </button>
                </div>
            </div>
